namespace DominoPizza.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DominosPizza.Models.DominosContext>
    {
        ...
        protected override void Seed(DominosContext db)
        {
            ...
            //db.Users.Add(new User { FirstName = "Анонимный", LastName = "Клиент", BirthDate = DateTime.Now, Sex = "-", Email = "client@domino.loc", Password = "12345", PasswordConfirm = "12345", UserRoleId = 1 });
            //db.Users.Add(new User { FirstName = "Тестовый", LastName = "Администратор", BirthDate = DateTime.Now, Sex = "-", Email = "admin@domino.loc", Password = "12345", PasswordConfirm = "12345", UserRoleId = 5 });
            //db.Users.Add(new User { FirstName = "Анна", LastName = "Михайлова", BirthDate = DateTime.Now, Sex = "женский", Email = "manager@domino.loc", Password = "12345", PasswordConfirm = "12345", UserRoleId = 2 });
            //db.Users.Add(new User { FirstName = "Пётр", LastName = "Романов", BirthDate = DateTime.Now, Sex = "мужской", Email = "cook@domino.loc", Password = "12345", PasswordConfirm = "12345", UserRoleId = 3 });
            //db.Users.Add(new User { FirstName = "Иван", LastName = "Сидоров", BirthDate = DateTime.Now, Sex = "мужской", Email = "courier@domino.loc", Password = "12345", PasswordConfirm = "12345", UserRoleId = 4 });
            //db.Users.Add(new User { FirstName = "Алексей", LastName = "Иванов", BirthDate = DateTime.Now, Sex = "мужской", Email = "client2@domino.loc", Password = "12345", PasswordConfirm = "12345", UserRoleId = 1 });
            //db.Contacts.Add(new Contact { FullName = "Алексей Иванов", Phone = "+78142345678", Address = "г.Петрозаводск, ул. Шотмана, д.13, кв. 22", OrderDateTime = DateTime.Now, UserId = 6 });
