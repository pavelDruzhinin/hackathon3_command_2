namespace DominoPizza.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DominosPizza.Models.DominosContext>
    {
        ...
        /*              db.UserRoles.Add(new UserRole { UserRoleId = 1, UserRoleName = "Менеджер" });
           ...
           db.Users.Add(new User { UserRoleId = 1, UserFirstName = "АннаМенеджер" });
           db.Users.Add(new User { UserRoleId = 2, UserFirstName = "ПётрПовар" });
           db.Users.Add(new User { UserRoleId = 3, UserFirstName = "ИванКурьер" });
           db.Customers.Add(new Customer {  CustomerFirstName = "АннаМенеджер", CustomerBirthDate = DateTime.Now });
           db.Customers.Add(new Customer {  CustomerFirstName = "ПётрПовар", CustomerBirthDate = DateTime.Now });
           db.Customers.Add(new Customer {  CustomerFirstName = "ИванКурьер", CustomerBirthDate = DateTime.Now });
